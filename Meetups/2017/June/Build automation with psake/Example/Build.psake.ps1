...
Task Analyze -depends StageFiles -requiredVariables ModuleOutDir, ScriptAnalysisEnabled, ScriptAnalyzerSettingsPath, ScriptAnalysisFailBuildOnSeverityLevel {
