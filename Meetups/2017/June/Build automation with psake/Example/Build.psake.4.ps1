Properties {
    ...
    # you publish you will be prompted to enter your API key.
...
Task Publish -depends Setup, Analyze, Test -requiredVariables BuildLocation {
    if ($NuGetApiKey) {
        ...
        $cred = Get-Credential -Message 'Enter your NuGet API key in the password field'
